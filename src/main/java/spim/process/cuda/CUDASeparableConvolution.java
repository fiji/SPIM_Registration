...
public interface CUDASeparableConvolution extends CUDAStandardFunctions
{
	...
	public boolean convolve_255( float[] image, float[] kernelX, float[] kernelY, float[] kernelZ, int imageW, int imageH, int imageD, boolean convolveX, boolean convolveY, boolean convolveZ, int outofbounds, float outofboundsvalue, int devCUDA );
