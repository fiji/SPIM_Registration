...
public class FusedWeightsRandomAccessibleInterval implements RandomAccessibleInterval< FloatType >
{
	final int n;
	...
	public FusedWeightsRandomAccessibleInterval(
			final Interval interval,
			final List< RandomAccessibleInterval< FloatType > > weights )
	{
	...
	{
		return new FusedWeightsRandomAccess( n, weights );
	}
