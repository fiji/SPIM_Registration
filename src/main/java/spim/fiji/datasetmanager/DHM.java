...
public class DHM implements MultiViewDatasetDefinition
{
	...
	public SpimData2 createDataset()
	{
		...
		final SpimData2 spimData = new SpimData2( meta.getDir(), sequenceDescription, viewRegistrations, viewInterestPoints, new BoundingBoxes(), new PointSpreadFunctions(), new StitchingResults() );
